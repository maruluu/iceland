export const allItineraryData = [
        ...
        { dayGroup: "Day 13", dayTitle: "Day 13: 10/17(四) 阿姆斯特丹經典與在地體驗", mapCenter: { lat: 52.3676, lng: 4.9041 }, mapZoom: 13, items: [
            ...
            {地點: "Jordaan 區探索", 描述: "在最有特色的住宅區漫步，尋找隱藏小店、二手市場和街頭藝術", 類別: "🚶‍♂️ 漫步", lat: 52.3740, lng: 4.8830, mapLabel: "Jordaan Exploration", mapPriority: 6, 照片: "https://images.unsplash.com/photo-1586862792267-2411ead5c607?w=1200&h=800&fit=crop"},
            ...
            {地點: "Brown Café 晚餐", 描述: "在傳統荷蘭咖啡館享用道地荷蘭菜：炸肉丸 Bitterballen、荷蘭燉菜", 類別: "🧁 吃喝", lat: 52.3740, lng: 4.8830, mapLabel: "Traditional Brown Café", mapPriority: 8, 照片: "https://images.unsplash.com/photo-1555992336-03a23c7a8d63?w=1200&h=800&fit=crop"},
