export const allItineraryData = [
        ...
        { dayGroup: "Day 4", dayTitle: "Day 4: 10/9(四) 維克周邊與冰洞", mapCenter: { lat: 63.6, lng: -18.5 }, mapZoom: 9, items: [
            {地點: "Vik 集合 10:00 卡特拉火山冰洞 3h", 台幣: "7,000", 網址:"https://adventures.is/iceland/day-tours/ice-caves/katla-ice-cave-tour-under-the-volcano/", 圖片: "https://image.kkday.com/image/get/s1.kkday.com/product_181018/20240527121341_7vFCr/jpg", 類別: "🎭 活動", lat: 63.4177, lng: -18.9976, mapLabel: "維克(冰洞集合)", mapPriority: 1}, // Changed ⛱ 景點 to 🎭 活動
        ...
        // Day 13 (對應原 Day 1)
        {
            ...
            mapZoom: 12,
            items: [
                { 地點: "阿姆斯特丹中央站 → Steenwijk → 公車70/270 → 羊角村", 描述: "07:30 出發", 類別: "🚄 移動", 網址: "https://maps.google.com/?cid=5909847684150077508", mapLabel: "羊角村", mapPriority: 1 },
                { 地點: "羊角村", 描述: "運河風光：村內無汽車道路，以水道取代馬路，漫步於茅草屋與木橋間宛如童話。小船泛舟：租手划或電動小船，近距離欣賞水畔農舍與橋樑倒影。田園景致：Bovenwijde 湖畔遠眺開闊水面與綠野，拍攝最經典運河＋茅屋全景。", 類別: "🌷 景點", mapLabel: "羊角村", mapPriority: 2 },
                { 地點: "返回阿姆斯特丹", 描述: "15:30 出發", 類別: "🚄 移動", mapLabel: "阿姆斯特丹", mapPriority: 3 },
                { 地點: "夜遊阿姆斯特丹運河", 類別: "🌃 活動", 網址: "https://maps.google.com/?cid=2379724085717603866", mapLabel: "阿姆斯特丹運河", mapPriority: 4 },
                { 地點: "ibis Amsterdam Centre 或 Hotel Library Amsterdam", 類別: "🏨 住宿", mapLabel: "阿姆斯特丹住宿", mapPriority: 5 }
            ]
        },
        // Day 14 (對應原 Day 2)
        {
            ...
            mapZoom: 13,
            items: [
                { 地點: "阿姆斯特丹 → 鹿特丹中央站", 描述: "08:00 出發，放行李", 類別: "🚄 移動", mapLabel: "鹿特丹中央站", mapPriority: 1 },
                { 地點: "小孩堤防", 描述: "水上巴士202號至小孩堤防。排水風車群：19座18世紀風車展示荷蘭治水技術。風車博物館：部分風車可入內，了解抽水機構運作。運河漫步／遊船：沿堤防步道或水上遊船欣賞壯觀風車全景。", 類別: "🌷 景點", 網址: "https://maps.google.com/?cid=1790000000000000000", mapLabel: "小孩堤防", mapPriority: 2 }, // Placeholder CID for Kinderdijk
                { 地點: "返回鹿特丹", 描述: "14:30 出發", 類別: "🚤 移動", mapLabel: "鹿特丹", mapPriority: 3 },
                { 地點: "伊拉斯莫斯橋、馬克拱廊市場", 類別: "🛍️ 景點", 網址: "https://goo.gl/maps/9bEX1evLoA62", mapLabel: "伊拉斯莫斯橋", mapPriority: 4 },
                { 地點: "Holiday Inn Express Rotterdam Central Station", 類別: "🏨 住宿", mapLabel: "鹿特丹住宿", mapPriority: 5 }
            ]
        },
        // Day 15 (對應原 Day 3)
        {
            ...
            mapZoom: 13,
            items: [
                { 地點: "鹿特丹 → 布魯日", 描述: "08:00 出發，約2–2.5小時", 類別: "🚄 移動", mapLabel: "布魯日", mapPriority: 1 },
                { 地點: "布魯日漫遊", 描述: "市集廣場（Markt）與鐘樓：壯麗哥德鐘樓與行會會館雕飾。運河遊船：30分鐘小船航行，近距離欣賞中世紀建築倒映。愛情湖與貝居安會院：天鵝湖畔與白牆庭院，最適拍照靜心。", 類別: "🌷 景點", 網址: "https://maps.google.com/?cid=1790000000000000000", mapLabel: "布魯日老城", mapPriority: 2 }, // Placeholder CID for Bruges
                { 地點: "布魯日運河遊船", 描述: "14:00 出發", 類別: "🛶 活動", 網址: "https://maps.google.com/?cid=1790000000000000000", mapLabel: "布魯日運河", mapPriority: 3 }, // Placeholder CID for Canal Cruise
                { 地點: "愛情湖公園", 類別: "🌳 景點", 網址: "https://goo.gl/maps/WTRukQNRnDu", mapLabel: "愛情湖公園", mapPriority: 4 },
                { 地點: "貝居安會院", 類別: "⛪ 景點", 網址: "https://goo.gl/maps/edkDpguhwDC2", mapLabel: "貝居安會院", mapPriority: 5 },
                { 地點: "Hotel Bourgoensch Hof", 類別: "🏨 住宿", mapLabel: "布魯日住宿", mapPriority: 6 }
            ]
        },
        // Day 16 (對應原 Day 4)
        {
            ...
            mapZoom: 13,
            items: [
                { 地點: "布魯日 → 根特", 描述: "08:30 出發，25 分鐘", 類別: "🚄 移動", 網址: "https://goo.gl/maps/ygC7f8NjNa32", mapLabel: "根特", mapPriority: 1 },
                { 地點: "伯爵城堡", 類別: "🏰 景點", 網址: "https://goo.gl/maps/y8ZT7TJRG6K2", mapLabel: "伯爵城堡", mapPriority: 2 },
                { 地點: "格拉斯利河岸 & 科恩利河岸", 類別: "🌉 景點", 網址: "https://goo.gl/maps/WWesdvReKh32", mapLabel: "格拉斯利河岸", mapPriority: 3 },
                { 地點: "聖巴夫大教堂", 類別: "⛪ 景點", 網址: "https://goo.gl/maps/N8Qj6S64Yks", mapLabel: "聖巴夫大教堂", mapPriority: 4 },
                { 地點: "返回布魯日", 描述: "16:30 出發", 類別: "🚄 移動", mapLabel: "布魯日", mapPriority: 5 },
                { 地點: "Hotel Bourgoensch Hof", 類別: "🏨 住宿", mapLabel: "布魯日住宿", mapPriority: 6 }
            ]
        },
        // Day 17 (對應原 Day 5)
        {
            ...
            mapZoom: 13,
            items: [
                { 地點: "布魯日 → 布魯塞爾", 描述: "09:00 出發，約1小時", 類別: "🚄 移動", mapLabel: "布魯塞爾", mapPriority: 1 },
                { 地點: "大廣場", 類別: "🏛️ 景點", 網址: "https://goo.gl/maps/TCm7Gnh8XfH2", mapLabel: "大廣場", mapPriority: 2 },
                { 地點: "午餐 Rue des Bouchers 美食街", 類別: "🍟 吃喝", 網址: "https://goo.gl/maps/HY7rxET3W9x", mapLabel: "Rue des Bouchers 美食街", mapPriority: 3 },
                { 地點: "聖於貝爾長廊", 類別: "🛍️ 景點", 網址: "https://goo.gl/maps/PuRP9NdhjNz", mapLabel: "聖於貝爾長廊", mapPriority: 4 },
                { 地點: "小尿童", 類別: "🚶 景點", 網址: "https://goo.gl/maps/L41eBytXemH2", mapLabel: "小尿童", mapPriority: 5 },
                { 地點: "蒙德藝術山", 類別: "🖼️ 景點", 網址: "https://goo.gl/maps/p94diVKNxkt", mapLabel: "蒙德藝術山", mapPriority: 6 },
                { 地點: "easyHotel Brussels City Centre", 類別: "🏨 住宿", mapLabel: "布魯塞爾住宿", mapPriority: 7 }
            ]
        },
        // Day 18 (對應原 Day 6)
        {
            ...
            mapZoom: 13,
            items: [
                { 地點: "布魯塞爾 → 鹿特丹 → 代爾夫特", 描述: "08:00 出發", 類別: "🚄 移動", 網址: "https://goo.gl/maps/fZbJK7vA4Wz", mapLabel: "代爾夫特", mapPriority: 1 },
                { 地點: "代爾夫特老城區", 描述: "市集廣場（Markt）與新教堂（Nieuwe Kerk）斜塔。舊教堂（Oude Kerk）斜塔拍照。皇家代爾夫特藍陶工廠（若有時間）。", 類別: "🏘️ 景點", 網址: "https://goo.gl/maps/LNjV8nNv51P2", mapLabel: "代爾夫特老城", mapPriority: 2 },
                { 地點: "市集廣場", 類別: "🛍️ 景點", 網址: "https://goo.gl/maps/EiwDXPjogkM2", mapLabel: "市集廣場", mapPriority: 3 },
                { 地點: "代爾夫特 → 阿姆斯特丹", 描述: "14:30 出發", 類別: "🚄 移動", mapLabel: "阿姆斯特丹", mapPriority: 4 },
                { 地點: "九條街", 類別: "🚴 活動", 網址: "https://goo.gl/maps/zKwiHJ88k7F2", mapLabel: "九條街", mapPriority: 5 },
                { 地點: "喬丹區", 類別: "🚶 景點", 網址: "https://goo.gl/maps/RnvK8ZRZAxw", mapLabel: "喬丹區", mapPriority: 6 },
                { 地點: "ibis Amsterdam Centre 或 Hotel Library Amsterdam", 類別: "🏨 住宿", mapLabel: "阿姆斯特丹住宿", mapPriority: 7 }
            ]
        },
        // Day 19 (對應原 Day 7)
        {
            ...
            mapZoom: 13,
            items: [
                { 地點: "阿姆斯特丹中央站 → 薩恩塞斯安斯", 描述: "09:00 出發", 類別: "🚄 移動", 網址: "https://goo.gl/maps/rt58PmoxUB62", mapLabel: "風車村", mapPriority: 1 },
                { 地點: "薩恩塞斯安斯風車村", 描述: "保留運轉中的18世紀製油、鋸木等風車。奶酪農舍與木鞋作坊示範並試吃／購買紀念品。沿桑河畔步道拍攝標誌性風車草地鄉村景觀。", 類別: "🌷 景點", mapLabel: "薩恩塞斯安斯風車村", mapPriority: 2 },
                { 地點: "返回阿姆斯特丹", 描述: "13:30 出發", 類別: "🚄 移動", mapLabel: "阿姆斯特丹", mapPriority: 3 },
                { 地點: "馮德爾公園", 類別: "🌳 景點", 網址: "https://goo.gl/maps/4Y8tEymHc7G2", mapLabel: "馮德爾公園", mapPriority: 4 },
                { 地點: "運河夜遊船", 類別: "🌃 活動", 網址: "https://goo.gl/maps/CQtQjx95PQK2", mapLabel: "運河夜遊船", mapPriority: 5 },
                { 地點: "ibis Amsterdam Centre 或 Hotel Library Amsterdam", 類別: "🏨 住宿", mapLabel: "阿姆斯特丹住宿", mapPriority: 6 }
            ]
        },
        // Day 20 - 回程日
        {
            ...
            mapZoom: 11,
            items: [
                { 地點: "阿姆斯特丹市區", 描述: "最後在阿姆斯特丹市區悠閒度過上午時光", 類別: "⛱ 景點", mapLabel: "阿姆斯特丹市區", mapPriority: 1 },
                { 地點: "前往機場", 描述: "搭火車或機場巴士前往 Schiphol 機場", 類別: "🚗 移動", mapLabel: "To Schiphol Airport", mapPriority: 2 },
                { 地點: "阿姆斯特丹機場 Schiphol", 描述: "辦理登機手續，準備回台灣", 類別: "✈️ 飛行", mapLabel: "Schiphol Airport", mapPriority: 3 }
            ]
        }
    ];
